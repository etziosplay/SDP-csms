...
int main()
{
    ...
    char items[6][100]= {"Sandisk 32 GB",
                         "Logitech Mouse",
    ...
    do
    {
        if(c==1)
        {
            ...
            case 1:
            {
                ...
                {
                    int num;
                    printf("\n\t\t\t\tYou chose Sandisk 32GB with tk .355. \n\n\t\t\t\t Are you sure to buy  ? \n\n\t\t\t\tIf 'Yes' Enter 1 else any number\n");
                    scanf("%d",&num);
                    if(num==1)
                    {
                        a[0]++;
            ...
            {
                int mobileChoice;
                printf("\n\t\t\t\tEnter\n\n\t\t\t\t->1 - Mi Note 12 - tk.11000\n\n\t\t\t\t->2 - Samsung Galaxy S22 - tk.9866\n\n\n\t\t\t\tAny other number to exit\n");
                ...
                {
                    int num;
                    printf("\n\t\t\t\tYou chose to buy Mi Note 12 for tk.11000.\n\n\t\t\t\t Are you sure to buy ? \n\n\t\t\t\tIf 'Yes' Enter 1 else any number\n");
                    scanf("%d",&num);
                    if(num==1)
                    {
                        a[4]++;
                ...
                {
                    int num;
                    printf("\n\n\t\t\t\t You chose to buy Samsung Galaxy S22 for tk.9866.\n\n\t\t\t\t  Are you sure to buy  ? \n\n\t\t\t\tIf 'Yes' Enter 1 else any number\n");
                    scanf("%d",&num);
                    if(num==1)
                    {
                        a[5]++;
